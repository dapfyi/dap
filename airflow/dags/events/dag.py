...
import mmh3
from utils import eth_ip, eth_threads
...
def checkpoint(partitions):
    ...
    past_reload = args['last_block'] >= (args['epoch'] + 2) * etl.EPOCH_LENGTH
...
def event_etl():
    ...
    for i in range(THREADS):
        partitions.append(thread(i, args))
